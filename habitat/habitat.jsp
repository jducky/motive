	...
	<div class="sideMenu" style="width: 11%; height: 600px;">
		...
		<div style="width: 100%; height: 100%;">
			...
			<!-- 		<ul class="ul1_menu2">
				...
				<li class="on"><a href="habitat.hb">> 취약서식지</a></li>
			</ul>
		</div>
	</div>
		...
		<div style="display:flex; height:100%;">
			...
			<div style="width: 12%; height: 80%;border:1px solid black; ">
				...
				<div style = "margin-left : 10px;">
					<a style="float:left; font-size: 20px; font-weight: bold;">예측 결과</a>
					<br><br>
					...
					<label style = "display : block; font-size : 18px; font-weight : bold; margin-top : 20px;" for = "mapInfo">지도정보</label>
					<select id = "mapInfo" style = "width : 115px;">
						<option>지도(행정구역)</option>
					</select>
				</div>
			</div>
			...
			<div style="width : 88%">
				<div id="tabMenu" style="width: 100%; height: 40px;  display : flex;">
					<div class="tabOn" style="width: 12.5%; height: 40px; border:1px solid black; float:left; text-align: center; line-height: 40px;  font-size: 17px; font-weight: bold; ">
						<a href="#">생물종 분포</a>
					</div>
					...
					<div  style="width: 12.5%; height: 40px; border:1px solid black; float:left; text-align: center; line-height: 40px;  font-size: 17px; font-weight: bold; ">
						<a href="#">생물종 유지</a>
					</div>
