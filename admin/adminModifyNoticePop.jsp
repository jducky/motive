...
<body>
	<form action = "modifyNoticePro.ad" id = "noticeForm" method = "POST" enctype = "multipart/form-data" accept-charset = "UTF-8">
			...
			<tr>
				...
				<td>
					<select id = "noticeClassifi" name = "noticeClassifi">
						...
						<option value = "등록기관">등록 기관</option>
				...
				<td>${vo.ins_id}</td>
				<th>등록일</th>
				<td><p id = "noticeToday">${vo.ins_date}</p></td>
			</tr>
			<tr>
				<th>제목</th>
				<td colspan = "5"><input type = "text" name = "noticeName" id = "noticeName" value="${vo.board_name}"/></td>
			</tr>
			<tr>
				<th>내용</th>
				<td colspan = "5">
		...
		<button id = "noticeIns" type = "button" style = " margin-left : 442px; margin-top : 5px; height : 30px;" class = "btn-primary">수정</button>
	</form>
</body>
</html>
