	...
	<div class="sideMenu" style="width: 11%; height: 600px;">
		...
		<div style="width: 100%; height: 100%;">
			<ul>
				...
				<li  class = "on"><a href="modelResult.do">> 모형 결과 분석</a></li>
		...
		<div style = "border:1px solid #d3d3d3; width : 1200px; height : 90%; ">
			...
			<div  style = "margin-left : 3%;">
				<div style = "display : flex; margin-top : 1%;">
					...
					<h2 style = "margin-left : 1%;">모형 결과 해석</h2>
				</div>
				<div style = "margin-left : 3%;">
					<p style = "font-size : 18px; color : #DBDBDB;">기초 설명</p>		
				</div>
				
				<div style = "display : flex; margin-top : 17%;">
					<p style = "font-size : 25px; color :  rgb(171 , 201 , 39); margin-top : 1%;">⦁</p>
					<h2 style = "margin-left : 1%;">모형 검증 및 출처</h2>
				</div>
				<div style = "margin-left : 3%;">
					<p style = "font-size : 18px; color : #DBDBDB;">기초 설명</p>		
				</div>
